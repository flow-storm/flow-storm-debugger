...
----
;; on Linux and OSX
clj -Sforce -Sdeps '{:deps {} :aliases {:dev {:classpath-overrides {org.clojure/clojure nil} :extra-deps {com.github.flow-storm/clojure {:mvn/version "1.12.3"} com.github.flow-storm/flow-storm-dbg {:mvn/version "4.5.6"}}}}}' -A:dev
...
{...
 ...
 {:1.12-storm {:classpath-overrides {org.clojure/clojure nil}
               :extra-deps {com.github.flow-storm/clojure {:mvn/version "1.12.3"}
...
----
{:1.12-storm
 {:dependencies [[com.github.flow-storm/clojure "1.12.3"]
