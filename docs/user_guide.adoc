...
.ClojureStorm
====
Instructions here only apply to vanilla _FlowStorm_. If you are using _ClojureStorm_ or _ClojureScriptStorm_
...
image::user_guide_images/bookmarks_open_btn.png[]
...
(#object[...FnCallTrace ... "[0 FnCallTrace] ..."]
 #object[...FnCallTrace ... "[1 FnCallTrace] ..."]
 #object[...FnCallTrace ... "[2 FnCallTrace] ..."])
...
Notice that each of this entries contains a thread-id also.
