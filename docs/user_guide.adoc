...
and also add `flow-storm.storm-preload` to your preloads.
...
[,bash]
----
clj -Sforce -Sdeps '{:deps {com.github.jpmonettas/flow-storm-dbg {:mvn/version "RELEASE"}}}' -X flow-storm.debugger.main/start-debugger :port 9000 :repl-type :shadow :build-id :my-app
----
...
[,bash]
----
clj -J-Dcljs.storm.instrumentOnlyPrefixes=org.foo -J-Dcljs.storm.instrumentEnable=true -Sdeps '{:paths ["src"] :deps {com.github.jpmonettas/clojurescript {:mvn/version "RELEASE"} com.github.jpmonettas/flow-storm-inst {:mvn/version "RELEASE"}}}' -M -m cljs.main -co '{:preloads [flow-storm.storm-preload] :main org.foo.core}' --compile
----
...
[,bash]
----
clj -J-Dcljs.storm.instrumentOnlyPrefixes=org.foo -J-Dcljs.storm.instrumentEnable=true -Sdeps '{:paths ["src"] :deps {com.github.jpmonettas/clojurescript {:mvn/version "RELEASE"} com.github.jpmonettas/flow-storm-inst {:mvn/version "RELEASE"}}}' -M -m cljs.main -co '{:preloads [flow-storm.storm-preload] :main org.foo.core}' --repl
----
...
Here is a repo you can use if you want to try _FlowStorm_ with shadow-cljs https://github.com/jpmonettas/shadow-flow-storm-basic
...
- https://raw.githubusercontent.com/jpmonettas/flow-storm-debugger/master/docs/high_level_diagram.svg
- https://raw.githubusercontent.com/jpmonettas/flow-storm-debugger/master/docs/timeline.svg
- https://raw.githubusercontent.com/jpmonettas/flow-storm-debugger/master/docs/run_configs.svg
