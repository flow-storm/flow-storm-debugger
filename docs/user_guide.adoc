...
You can recompile it as usual with your editor commands, or by using the `Reload namespace` option in the menu, which will
execute a `(require 'the-selected.namespace :reload)` expression for you.
====
