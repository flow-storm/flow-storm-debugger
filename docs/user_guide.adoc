...
----
;; on Linux and OSX
clj -Sforce -Sdeps '{:deps {} :aliases {:dev {:classpath-overrides {org.clojure/clojure nil} :extra-deps {com.github.flow-storm/clojure {:mvn/version "1.12.0-8"} com.github.flow-storm/flow-storm-dbg {:mvn/version "4.2.0"}} :jvm-opts ["-Dclojure.storm.instrumentEnable=true"]}}}' -A:dev
...
{...
 :aliases {:1.12-storm
           {;; for disabling the official compiler
            ...
            :extra-deps {com.github.flow-storm/clojure {:mvn/version "1.12.0-8"}
...
----
{:1.12-storm
 {:dependencies [[com.github.flow-storm/clojure "1.12.0-8"]
