...
FlowStorm works fine with most macros, except the ones that don't preserve meta at macroexpansion, which FlowStorm needs in order
to link the executed code back to the original source code.
